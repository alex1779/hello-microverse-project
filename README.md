...
**[hello-microverse-project]** This is an example of github flow. Add new feature branch and make commits.
...
```sh
  cd my-folder
  git clone git@github.com:alex1779/hello-microverse-project.git
